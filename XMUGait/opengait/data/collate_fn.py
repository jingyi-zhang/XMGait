...
class CollateFn(object):
    ...
    def __call__(self, batch):
        ...
        seqs_batch, labs_batch, typs_batch, vies_batch,height_batch, gender_batch = \
            [], [], [], [],[],[]
        ...
        for bt in batch:
            ...
            height_batch.append(bt[1][3])
            gender_batch.append(bt[1][4])
        ...
        batch = [fras_batch, labs_batch, typs_batch, vies_batch,height_batch, gender_batch, None]
