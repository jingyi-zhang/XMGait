            ...
            for lab in label_set:
                for typ in sorted(os.listdir(osp.join(dataset_root, lab))):
                    for vie in sorted(os.listdir(osp.join(dataset_root, lab, typ))):
                        ...
                        if f'90-{vie}-LiDAR-warp.pkl' in seq_dirs:
                            seq_dirs = [
                                osp.join(seq_path, f'00-{vie}-LiDAR-PCDs.pkl'),
                                osp.join(seq_path, f'01-{vie}-LiDAR-PCDs_depths.pkl'),
                                osp.join(seq_path, f'90-{vie}-LiDAR-warp.pkl')]    
